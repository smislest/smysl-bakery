      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="hidden md:block absolute left-0 top-1/2 -translate-y-1/2 w-[240px] xl:w-[280px]">
          <picture>
            ...
            <img src="/img/l_wheat.png" alt="" className="w-full h-auto select-none" draggable={false} loading="lazy" width={250} height={400} />
          </picture>
        </div>
        <div className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 w-[240px] xl:w-[280px]">
          <picture>
            ...
            <img src="/img/r_wheat.png" alt="" className="w-full h-auto select-none" draggable={false} loading="lazy" width={250} height={400} />
          </picture>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-5xl font-bold text-[#c1dedc] mb-4">Контакты</h1>
              <p className="text-xl text-[#ffecc6]">Свяжитесь с нами любым удобным способом</p>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 space-y-8 border border-white/10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#ffecc6]">{seoData?.business_address || ''}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm mt-2">Звонки принимаются ежедневно с 9:00 до 21:00</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#ffecc6]">Понедельник - Пятница: 8:00 - 20:00</p>
                    <p className="text-[#ffecc6]">Суббота - Воскресенье: 10:00 - 18:00</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
                  ...
                  <div className="space-y-3 text-[#ffecc6]">
                    <p><strong className="text-[#c1dedc]">Доставка по Москве:</strong> от 500 ₽</p>
                    <p><strong className="text-[#c1dedc]">Бесплатная доставка:</strong> при заказе от 3000 ₽</p>
                    <p><strong className="text-[#c1dedc]">Самовывоз:</strong> бесплатно</p>
                  </div>
                </div>
